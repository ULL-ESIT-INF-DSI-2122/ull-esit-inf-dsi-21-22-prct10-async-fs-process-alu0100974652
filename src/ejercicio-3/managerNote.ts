...
export class ManagerNote {
    ...
    addNote(addNoteToUser: Note) {
        const rute: string = '/home/usuario/prct10/src/ejercicio-3/database/' + this.user
        const fileRute: string =  '/home/usuario/prct10/src/ejercicio-3/database/' + this.user + '/' + addNoteToUser.getTitle() + '.json'
